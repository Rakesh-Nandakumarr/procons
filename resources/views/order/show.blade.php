...
<x-app-layout>
    <div class="container max-w-4xl mx-auto mt-1">
        <div class="space-y-5 divide-y divide-gray-900/10">
            ...
            <h2 class="text-xl font-bold text-gray-800 mx-auto text-center mt-5">Order Details</h2>
                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2 p-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('order.index') }}"
                            class="text-sm font-semibold leading-6 text-indigo-900">Back to Orders</a>
                    </div>
                </div>
            </div>
        </div>
